...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(e,t,n){let r=new Float32Array(La),i=new J(0,1,0);return new Si({name:`SphericalGaussianBlur`,defines:{n:La,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new Si({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:eo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Si({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:eo(),fragmentShader:`
...
`)}var Ds={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Os(e,t){let n=Ds[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ks=new J;function As(){return X.getLuminanceCoefficients(ks),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ks.x.toFixed(4)}, ${ks.y.toFixed(4)}, ${ks.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ys(i,i.VERTEX_SHADER,y),S=ys(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ts(i,x,`vertex`),n=Ts(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
scene.add(cube);`:`import * as THREE from 'three';
...
scene.add(cube);`);function de(){navigator.clipboard.writeText(ue.value),E.value=!0,setTimeout(()=>{E.value=!1},2e3)}return(t,s)=>(d(),a(`div`,Vc,[i(`div`,Hc,[i(`div`,Uc,[i(`button`,{class:r([`tab-toggle-btn`,{active:C.value===`preview`}]),onClick:s[0]||=e=>C.value=`preview`},[...s[5]||=[i(`svg`,{class:`tab-icon`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`},[i(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,"stroke-width":`2`,d:`M15 12a3 3 0 11-6 0 3 3 0 016 0z`}),i(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,"stroke-width":`2`,d:`M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z`})],-1),e(` Preview `,-1)]],2),i(`button`,{class:r([`tab-toggle-btn`,{active:C.value===`code`}]),onClick:s[1]||=e=>C.value=`code`},[...s[6]||=[i(`svg`,{class:`tab-icon`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`},[i(`path`,{"stroke-linecap":`round`,"stroke-linejoin":`round`,"stroke-width":`2`,d:`M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4`})],-1),e(` Code `,-1)]],2)]),s[7]||=i(`span`,{class:`demo-badge`},`Three.js WebGL Renderer`,-1)]),n(i(`div`,Wc,[i(`div`,Gc,[i(`div`,Kc,[i(`button`,{class:r([`pill-btn`,{active:w.value===`continuous`}]),onClick:s[2]||=e=>w.value=`continuous`},` Continuous Gradient `,2),i(`button`,{class:r([`pill-btn`,{active:w.value===`categorical`}]),onClick:s[3]||=e=>w.value=`categorical`},` Categorical (6 Faces) `,2)]),i(`div`,qc,[s[8]||=i(`label`,{for:`cube-scheme-select`,class:`select-label`},`Scheme:`,-1),n(i(`select`,{id:`cube-scheme-select`,"onUpdate:modelValue":s[4]||=e=>T.value=e,class:`scheme-select`},[(d(),a(f,null,o(O,e=>i(`option`,{key:e,value:e},p(e),9,Jc)),64))],512),[[_,T.value]])])]),i(`div`,{ref_key:`canvasContainer`,ref:D,class:`cube-viewport`,onMousedown:I,onMousemove:L,onMouseup:se,onMouseleave:se,onTouchstart:ce,onTouchmove:le,onTouchend:se},[...s[9]||=[i(`div`,{class:`viewport-hint`},`Drag mouse to rotate 3D WebGL Cube`,-1)]],544),w.value===`continuous`?(d(),a(`div`,Yc,[i(`div`,Xc,[i(`div`,{class:`gradient-bar-fill`,style:c({background:ne.value})},null,4)]),i(`div`,Zc,[(d(!0),a(f,null,o(re.value,(e,t)=>(d(),a(`div`,{key:t,class:`tick-item`},[i(`span`,Qc,`t = `+p(e.t),1),i(`span`,$c,p(e.hex),1),i(`span`,el,p(e.rgb),1)]))),128))])])):h(``,!0),w.value===`categorical`?(d(),a(`div`,tl,[(d(!0),a(f,null,o(ie.value,(e,t)=>(d(),a(`div`,{key:t,class:`legend-item`},[i(`div`,{class:`legend-swatch`,style:c({backgroundColor:e.css})},null,4),i(`div`,nl,[i(`span`,rl,p(e.face),1),i(`span`,il,p(e.hex),1),i(`span`,al,p(e.rgb),1)])]))),128))])):h(``,!0)],512),[[g,C.value===`preview`]]),n(i(`div`,ol,[i(`div`,sl,[s[10]||=i(`span`,null,`threejs-cube-mapping.ts`,-1),i(`button`,{class:`copy-code-btn`,onClick:de},p(E.value?`Copied!`:`Copy Code`),1)]),i(`pre`,cl,[i(`code`,null,p(ue.value),1)])],512),[[g,C.value===`code`]])]))}},[[`__scopeId`,`data-v-ab6f61c4`]]);export{ll as default};