---
title: Basics
description: Learn how to access, sample, and resample color schemes in ColorSchemes.js.
navigation:
...
```typescript
import { get, colorschemes } from 'color-schemes';
...
```typescript
import { resample, colorschemes } from 'color-schemes';
